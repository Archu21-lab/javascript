...
function displayBooks(books) {
  ...
  books.map((book) => {
    ...
    div.className = "col-4";
    div.innerHTML = `<div class="card" style="background-color:beige">
          
          <div class="card-body">
          <img src=${book.volumeInfo.imageLinks.thumbnail} style="height:250px" class="justify-content-center" alt="..." />
